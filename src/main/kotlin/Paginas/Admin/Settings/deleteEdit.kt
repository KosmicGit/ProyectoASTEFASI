                    ...
                    div {
                        div {
                            div {
                                ...
                                element("hr")
                                p { element.text("Está a punto de eliminar la cuenta de usuario:") }.classes("subtitle has-text-warning")
                                div {
                                    div {
                                ...
                                element("hr")
                                p { element.text("La ficha del Paciente / Terapeuta "); span { element.text("permanecerán") }.classes("has-text-danger"); element.addText((" en la base de datos hasta que el usuario solicite su eliminación.")) }.classes("has-text-grey-light")
                            }.classes("box")
